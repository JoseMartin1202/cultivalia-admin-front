...
const InputForm = ({ id, formik, onChangeExtra, message, password,number,preventSigns,descuento,negative,readonly}) => {
    ...
    return (
        <div className='flex flex-col w-full'>
            <div className='flex flex-row w-full' >
                ...
                className={`${readonly ? '':'focus:ring-2 focus:ring-indigo-400 focus:border-indigo-500 '} focus:outline-none w-full rounded-[10px] border-2 p-2`}
                placeholder={message}
