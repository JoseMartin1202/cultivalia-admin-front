...
const GenericModal = ({
  ...
  return (
    <div id="modalBackground" className={`absolute z-40 size-full left-0 top-0 bg-neutral-900/70 flex justify-center items-end sm:items-center`}>
      <div id="modalBox"
      className={`rounded-2xl flex flex-col w-full bg-white h-fit sm:w-4/5 lg:w-[70%]`}>
